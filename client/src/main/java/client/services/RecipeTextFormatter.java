...
public class RecipeTextFormatter {
    ...
    public static String toText(Recipe recipe, Function<UUID, String> ingredientNameResolver, ResourceBundle bundle) {
        StringBuilder sb = new StringBuilder();

        sb.append(recipe.getTitle()).append("\n\n");

        sb.append(bundle.getString("txt.ingredients")).append("\n");
        ...
        sb.append("\n").append(bundle.getString("txt.preparation")).append("\n");
