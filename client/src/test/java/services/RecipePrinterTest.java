...
public class RecipePrinterTest {
    ...
    @Test
    void printableRecipeContainsTitleAndSectionHeaders() throws Exception {
        Recipe recipe = createRecipe(
                "Pancakes",
                List.of("Flour", "Milk"),
                List.of("Mix ingredients", "Bake")
        );
        VBox root = invokePrintableRecipe(recipe);
    ...
    private VBox invokePrintableRecipe(Recipe recipe) throws Exception {
    ...
    /**
     * Helper to create a Recipe with correctly typed ingredients.
     */
